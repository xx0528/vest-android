...
object AdJustTool {
    fun init(ajToken: String) {
        ...
        val config = AdjustConfig(MainApplication.getInstance(), ajToken, AdjustConfig.ENVIRONMENT_PRODUCTION)
        ...
        MainApplication.getInstance().registerActivityLifecycleCallbacks(AdjustLifecycleCallbacks())
