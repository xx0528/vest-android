...
import a.F
import sw.ef.gh.login.LoginType.FacebookLogin
import sw.ef.gh.login.LoginType.GoogleLogin
import sw.ef.gh.login.LoginType.LinkedInLogin
import sw.ef.gh.login.LoginType.TwitterLogin
...
object LoginTool {
    ...
    fun initOnCreate(activity: ComponentActivity) {
        ...
        val data = F.getInstance().getData()
    ...
    fun login(context: G, loginType: LoginType, isWaitForResult: Boolean = true) : String {
        var resultStr = ""
